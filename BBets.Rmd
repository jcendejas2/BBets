...
We'll solve this problem by resampling. We'll set up days of the year, take a random sample of 35, and see if 2 or more have the same birthday.   
...
hist(results)
```
The amount that Dr. J would have to pay to make this a fair bet is 4.
...
The expected amount of students for a fair bet would be 28.  
